...
"use strict";
var input2 = document.querySelectorAll('#synopsis')[0],
    charCount = document.querySelector('#charCount'),
    wrdCount = document.querySelector('#wrdCount'),
    sentCount = document.querySelector('#sentCount'),
    parCount = document.querySelector('#parCount'),
...
input2.addEventListener('keyup', function() {
    ...
    charCount.innerHTML = input2.value.length;
    ...
    var words = input2.value.match(/\b[-?(\w+)?]+\b/gi);
    // console.log(words);
    if (words) {
        wrdCount.innerHTML = words.length;
    } else {
    ...
    if (words) {
        var sentences = input2.value.split(/[.|!|?]+/g);
        console.log(sentences);
        sentCount.innerHTML = sentences.length - 1;
    } else {
    ...
    if (words) {
        ...
        var paragraphs = input2.value.replace(/\n$/gm, '').split(/\n/);
        parCount.innerHTML = paragraphs.length;
    } else {
        parCount.innerHTML = 0;
    }
