...
public interface AnalyticsDAOInterface{
    ...
    ArrayList<Writer> getTopWriters(Integer noOfWriters, Date startPeriod, Date endPeriod);                             //Get the writers whose stories have the most views in a period of time.
    ArrayList<Editor> getTopEditors(Integer noOfEditors, Date startPeriod, Date endPeriod);                             //Get the editors who have edited the most stories over a period of time.
